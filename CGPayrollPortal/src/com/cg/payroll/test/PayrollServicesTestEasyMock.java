...
public class PayrollServicesTestEasyMock {
	...
	public void setUpTestMockData()	{
		Associate associate1 = new Associate(101, 5000, "satish", "kumar", "Dev", "Consultant", "LKPS5859A", "Satish333@gmail.com", new Salary(50000, 1000, 1000), new BankDetails(2024017807, "ICICI", "ICICI005"));
	...
	public void testGetAssociateDataForInvalidAssociateId() throws AssociateDetailsNotFoundException	{
		payrollServices.getAssociateDetails(12);
	}


	@Test(expected= AssociateDetailsNotFoundException.class)
	public void testGetAssociateDataForValidAssociateId() throws AssociateDetailsNotFoundException	{
		Associate expectedAssociate= new Associate(101,5000, "satish", "kumar", "Dev", "Consultant", "LKPS5859A", "Satish333@gmail.com", new Salary(50000, 1000, 1000), new BankDetails(2024017807, "ICICI", "ICICI005"));
